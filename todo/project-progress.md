...
- [ ] [medium] TODO 파일별 관련 커밋 찾기
- [ ] [medium] TODO 항목의 파일 경로와 코드 라인 연결
- [ ] [medium] 특정 줄의 마지막 수정 커밋 확인
- [ ] [medium] 특정 줄의 작성자·수정 시각·커밋 메시지 표시
...
- [ ] [medium] 여러 프로젝트의 오늘 작업을 하나의 목록으로 통합
- [ ] [medium] 개발 외 일정과 개인 메모를 별도 유형으로 표시
- [ ] [medium] 완료한 오늘 작업의 요약 표시
- [ ] [medium] 프로젝트별 Markdown TODO 파일 진행 현황 표시
- [ ] [medium] 파일별 전체 항목·완료 항목·완료율 표시
- [ ] [medium] 진행 중인 Markdown 파일을 상단에 우선 표시
- [ ] [medium] 파일별 다음 작업과 마지막 동기화 시각 표시
- [ ] [medium] 필요할 때만 프로젝트별 상세 화면으로 이동
- [ ] [medium] 이번 주 일정과 프로젝트 진행률은 보조 영역에 표시
- [ ] [medium] 최근 Git 활동과 최근 수정 TODO는 하단 보조 영역에 표시

### 일정 관리

- [ ] [medium] 공통 일정 등록·수정·삭제
- [ ] [medium] 개발 외 일정 등록·수정·삭제
- [ ] [medium] 일정 유형 구분: 공통 / 개발 / 개인 / 회의 / 기타
- [ ] [medium] 일정별 날짜·시간·반복 여부·메모 관리
- [ ] [medium] 일정에 프로젝트 또는 TODO 연결
- [ ] [medium] 완료·취소·보류 상태 관리
